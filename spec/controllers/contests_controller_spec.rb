...
describe ContestsController do
  ...
  def valid_attributes
    { "name" => "Sample Contest", begin_at: Time.now, end_at: Time.now }
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contest as @contest" do
        ...
        post :create, {:contest => { "name" => "invalid value" }}
        assigns(:contest).should be_a_new(Contest)
      end
      ...
      it "re-renders the 'new' template" do
        # Trigger the behavior that occurs when invalid params are submitted
        Contest.any_instance.stub(:save).and_return(false)
        Contest.any_instance.stub(:errors).and_return([name: 'required'])
        post :create, {:contest => { "name" => "invalid value" }}
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contest" do
        ...
        Contest.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => contest.to_param, :contest => { "name" => "MyString" }}
      end

      it "assigns the requested contest as @contest" do
        contest = Contest.create! valid_attributes
        put :update, {:id => contest.to_param, :contest => valid_attributes}
        assigns(:contest).should eq(contest)
      end
    ...
    describe "with invalid params" do
      it "assigns the contest as @contest" do
        contest = Contest.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Contest.any_instance.stub(:valid?).and_return(false)
        put :update, {:id => contest.to_param, :contest => { "name" => "invalid value" }}
        assigns(:contest).should eq(contest)
      end
      ...
      it "re-renders the 'edit' template" do
        ...
        Contest.any_instance.stub(:valid?).and_return(false)
        Contest.any_instance.stub(:errors).and_return([name: 'required'])
        put :update, {:id => contest.id.to_param, :contest => { "name" => "invalid value" }}
